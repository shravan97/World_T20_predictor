...
content = urllib2.urlopen('http://stats.espncricinfo.com/ci/engine/team/'+team_no+'.html?class=2;host=25;spanmin1=01+Jan+2000;spanval1=span;template=results;type=team;view=results').read()
